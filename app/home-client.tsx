...
export default function HomeClient() {
  return (
    <div className="flex flex-col gap-24 md:gap-32 pb-24">
      ...
      <section className="container mx-auto px-4 md:px-6">
        <div className="glassmorphism-card rounded-3xl p-6 md:p-8 flex flex-col md:flex-row items-center justify-between gap-6 max-w-5xl mx-auto border border-primary/20">
          <div className="flex items-center gap-4">
            <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-primary/20 to-accent/20 border border-primary/30 flex items-center justify-center font-bold text-primary text-lg shadow-inner flex-shrink-0">
              SS
            </div>
            <div className="text-left">
              <Badge className="bg-primary/10 border-primary/20 text-primary text-[10px] rounded-full px-2.5 py-0.5 mb-1 font-bold">
                Executive Leadership
              </Badge>
              <h3 className="text-lg font-bold text-foreground tracking-tight">Srinivasan Subramani</h3>
              <p className="text-xs text-muted-foreground">Chief Executive Officer (CEO), Indusnet AI</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
            <a href="tel:+919786887769" className="text-xs font-semibold text-white bg-gradient-to-r from-primary to-accent px-5 py-2.5 rounded-full hover:brightness-110 shadow-md shadow-primary/20 transition-all flex items-center gap-2">
              <span>CEO Direct Line:</span>
              <span className="font-bold">+91-97868-87769</span>
            </a>
          </div>
        </div>
      </section>
