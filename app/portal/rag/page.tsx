          ...
          <Card className="glassmorphism-card border border-border shadow-2xl overflow-hidden rounded-3xl">
            <CardContent className="p-8 md:p-10 flex flex-col gap-6">
              ...
              <div className="text-center flex flex-col items-center gap-3">
                ...
                <div>
                  <Badge className="bg-primary/10 border border-primary/20 text-primary rounded-full px-3 py-0.5 text-[10px] uppercase font-bold tracking-wider mb-2">
                    VPC-Isolated RAG Engine
                  </Badge>
                  <h1 className="text-2xl font-extrabold text-foreground tracking-tight font-heading">
                    Secure RAG Portal
                  </h1>
                  <p className="text-xs text-muted-foreground mt-1">
                    Indus Net AI Enterprise Vector Search Workstation
                  </p>
                </div>
              </div>
              ...
              <form onSubmit={handleLogin} className="flex flex-col gap-4">
                <div className="flex flex-col gap-1.5">
                  ...
                  <Input
                    ...
                    placeholder="analyst@metrofinancial.com"
                    className="bg-muted border-border text-foreground text-xs px-4 h-10 rounded-xl focus-visible:ring-primary/60"
                  />
                </div>
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <div className="relative">
                    <Input
                      ...
                      placeholder="••••••••••••"
                      className="bg-muted border-border text-foreground text-xs pl-4 pr-10 h-10 rounded-xl focus-visible:ring-primary/60"
                    />
                    <button
                      type="button"
                ...
                <Button
                  ...
                  className="w-full rounded-xl bg-gradient-to-r from-primary to-accent text-white font-semibold h-10 hover:brightness-110 shadow-lg shadow-primary/20 transition-all mt-2"
                >
                  {loginLoading ? (
                    ...
                    <span className="flex items-center justify-center gap-2">
                      Sign In to RAG Workstation <ArrowRight className="w-4 h-4" />
                    </span>
                  )}
                </Button>
              </form>
              ...
              <Button
                ...
                className="w-full rounded-xl border-border bg-muted/50 hover:bg-muted text-foreground text-xs font-semibold h-10 gap-2 transition-all"
              >
              ...
              <div className="pt-2 text-center border-t border-border/50">
                <p className="text-[11px] text-muted-foreground">
                  Need a custom RAG cluster setup?{" "}
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h1 className="font-bold text-foreground text-base tracking-tight">RAG Enterprise Workstation</h1>
                <Badge className="bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-[10px] rounded px-2 font-mono">
                  Online
                </Badge>
              </div>
              <p className="text-xs text-muted-foreground flex items-center gap-2 mt-0.5">
                <span>Model: <strong className="text-foreground font-mono">Llama-3.1-70B (Azure GPU)</strong></span>
                <span>•</span>
                <span>Vector DB: <strong className="text-foreground font-mono">Qdrant VPC Cluster</strong></span>
              </p>
            </div>
          </div>
            ...
            <CardContent className="p-5 flex flex-col gap-4">
              <div className="flex items-center justify-between">
                <h2 className="font-bold text-xs uppercase text-primary tracking-wider flex items-center gap-1.5">
                  <Database className="w-4 h-4 text-primary" /> Active Vector Collection
                </h2>
                <Badge className="bg-muted text-muted-foreground border-border text-[10px] font-mono">
                  {selectedCollection.docsCount} Docs
                </Badge>
              </div>
