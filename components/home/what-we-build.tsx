          ...
          {CAPABILITIES.map((cap, idx) => {
            ...
            return (
              ...
              >
                <Link
                  href={cap.href}
                  className={`group flex flex-col gap-4 p-6 rounded-2xl border ${cap.border} bg-card hover:bg-card/80 hover:border-primary/40 hover:shadow-xl hover:shadow-primary/5 transition-all duration-300 h-full`}
                >
                  {/* Icon */}
                  <div
                    className={`w-10 h-10 rounded-xl ${cap.bg} ${cap.border} border flex items-center justify-center`}
                  >
                  ...
                  <div className="flex flex-col gap-2 flex-1">
                    <h3
                      className={`text-base font-bold font-heading text-foreground group-hover:${cap.color} transition-colors`}
                    >
                      {cap.title}
                    </h3>
                  ...
                  {/* Footer */}
                  <div
                    className={`flex items-center gap-1 text-xs font-semibold ${cap.color} group-hover:translate-x-1 transition-transform`}
                  >
