  ...
  return (
    <div className="relative w-full max-w-xl mx-auto flex flex-col items-center">
      ...
      <div className="absolute inset-0 -z-10 flex items-center justify-center pointer-events-none">
        <div className="w-[360px] h-[360px] rounded-full bg-primary/15 blur-[100px] animate-pulse" />
        <div className="w-[280px] h-[280px] rounded-full bg-[#7C5CFF]/10 blur-[90px]" />
      </div>

      {/* Main Operating Architecture Container Card */}
      <div className="w-full bg-[#08111F]/90 border border-[#162238] rounded-3xl p-5 sm:p-6 shadow-[0_24px_70px_rgba(5,11,20,0.7)] backdrop-blur-2xl relative overflow-hidden space-y-4">
        {/* Telemetry Header */}
        <div className="flex items-center justify-between pb-3 border-b border-[#162238]">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[11px] font-mono tracking-wider uppercase text-[#F5F7FA] font-bold">
              Enterprise Operating Architecture
            </span>
          </div>

          <Badge variant="outline" className="text-[10px] font-mono py-0 text-cyan-400 border-cyan-500/30 bg-cyan-500/5">
        ...
        <div className="space-y-1.5">
          <div className="flex items-center justify-between px-1">
            <span className="text-[9px] font-mono uppercase font-bold tracking-widest text-[#6F7E91]">
              01 · Enterprise Inputs
            </span>
            <span className="text-[9px] font-mono text-cyan-400">Ingestion Tier</span>
          </div>
            ...
            {[
              ...
              return (
                <button
                  ...
                  className={`p-2.5 rounded-xl border text-center transition-all duration-200 flex flex-col items-center justify-center gap-1 group cursor-pointer ${
                    isSelected
                      ? "bg-[#0D1828] border-primary shadow-[0_0_15px_rgba(22,119,255,0.25)] text-white"
                      : "bg-[#0D1828]/60 hover:bg-[#0D1828] border-[#162238] text-[#A7B4C5] hover:text-[#F5F7FA] hover:border-primary/40"
                  }`}
                >
        ...
        <button
          ...
          className={`w-full p-3.5 rounded-2xl border text-left transition-all duration-200 relative overflow-hidden flex items-center justify-between cursor-pointer ${
            activeNodeKey === "intelligence"
              ? "bg-gradient-to-r from-primary/20 via-cyan-500/15 to-[#7C5CFF]/15 border-primary shadow-[0_0_25px_rgba(22,119,255,0.25)] ring-1 ring-primary/40"
              : "bg-[#0D1828]/80 hover:bg-[#0D1828] border-[#162238] hover:border-primary/50"
          }`}
        >
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-xl bg-primary text-white flex items-center justify-center shadow-md shadow-primary/30 shrink-0 border border-cyan-400/40">
        ...
        <div className="grid grid-cols-2 gap-2">
          ...
          >
            ...
            <div className="min-w-0">
              ...
              <span className="text-xs font-bold text-[#F5F7FA] block truncate">Applications</span>
            </div>
          </button>
          ...
          <button
            ...
            className={`p-3 rounded-xl border text-left transition-all duration-200 flex items-center gap-2.5 cursor-pointer ${
              activeNodeKey === "outcomes"
                ? "bg-[#0D1828] border-emerald-500 shadow-[0_0_15px_rgba(16,185,129,0.25)] text-white"
                : "bg-[#0D1828]/60 hover:bg-[#0D1828] border-[#162238] text-[#A7B4C5] hover:text-[#F5F7FA] hover:border-emerald-500/40"
            }`}
          >
            <CheckCircle2 className="w-4 h-4 text-emerald-400 shrink-0" />
            <div className="min-w-0">
              <span className="text-[9px] font-mono uppercase text-emerald-400 font-bold block">05 · Impact</span>
              <span className="text-xs font-bold text-[#F5F7FA] block truncate">Outcomes</span>
            </div>
          </button>
        </div>

        {/* Active Node Specification Inspector Drawer */}
        <div className="pt-3 border-t border-[#162238] bg-[#050B14]/85 -mx-5 -mb-6 p-4 rounded-b-3xl space-y-2.5">
          ...
          <div className="flex flex-wrap gap-1.5 pt-0.5">
            {activeNode.techs.map((tech, idx) => (
              <span
                key={idx}
                className="text-[9.5px] font-mono font-medium bg-[#0D1828] border border-[#162238] px-2 py-0.5 rounded text-[#F5F7FA]"
              >
                {tech}
              </span>
            ))}
